...
![gambar](img/ss%20menjalankan%20mysql.png)
### PENJELASAN
...
```
![img](img/membuat%20tabel.png)
# 3. MENAMBAHKAN DATA
![img](img/menambahkan%20data.png)
...
```
![img](img/menambahkan%20data%201.png)
Data berhasil ditambahkan
![img](img/menambahkan%20data%202.png)
```
...
![img](img/koneksiPHP.png)
Data berhasil terkoneksi
```
<?php
$host = "localhost";
$user = "root";
...
**PENJELASAN**<br>
Program menambahkan data atau **Create**<br>
![img](img/tanbahPHP1.png)
```code php
<?php
...
![img](img/ubahPHP.png)
maka hasilnya yang akan keluar seperti dibawah<br>
